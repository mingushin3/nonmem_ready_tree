...
- **status:** OPEN (측정 완료 — `bundles=[]`가 현 57-wired scope 정답임을 기록; 응축은 정규화 밀도화 gated 미래 기능, deferred). [[GAP-37]](Direction B mess 확장)·[[GAP-30]](배선 백로그)·[[GAP-27]]B(비가환)·[[GAP-33]]/[[GAP-34]](decision_tree)·[[GAP-25]](render perf, collapse-by-default) 연계.
