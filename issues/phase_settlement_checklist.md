...
- **테스트 baseline:** `python3 -m pytest tests/ -q` → **974 passed / 4 skipped / 1 xfailed**. (Phase 8b 962 + **Phase 9 `tests/test_phase9_adversarial.py` +12 = 974**; cross-SSOT durable guard, report-only·엔진/SSOT/render 무수정.) (이력: slice 9 917 + Phase 7 decision_tree 19+결정·골격=937; Phase 8 +16=953; Phase 8b +9=962.)
...
- **집계(총 36 GAP):** OPEN **20**(GAP-1~4, 6, 7, 9, 10, 11, 13, 14, 17, 18, 19, 22, 23, 24, 30, 32, **36**) · RESOLVED-잔여 **14**(GAP-5, 8, 12, 15, 16, 21, 25, 26, 27, 28, 29, 31, 33, **34**) · RESOLVED-clean **2**(GAP-20·GAP-35, 백로그 제외). (★ 2026-06-03 **Phase 8 렌더 완료 → GAP-25 완전 해소**: node-count(100/190) + dagre 라이브 ms(headless 64ms/total 122ms ≪10s) 둘 다 PASS. 결정 A·B: GAP-5/8/31 RESOLVE·GAP-12 Phase7-facet·GAP-33 골격완료·**GAP-34 신규**. 결정 C: GAP-28 scope-out RESOLVE. **Phase 8b(UAT)**: **GAP-35 신규(clean)** — 끊김 판정=정상·시각 명료성·종착 6색·경계 배너·recover edge 14. ★ 2026-06-03 **Phase 9(적대 검증)**: 기계화 12 불변식 PASS·DoD 6P/1B/1IP·Lock 7/7·candidate 4 무해/기문서화. **GAP-36 신규(OPEN, ②latent non-critical)** — 문서화 C_dead {c0042/c0043/c0333}의 "tree-live" 미실현 + DoD#3 C1=119/122 bound가 living ledger 미기록. 종합 `issues/phase9_adversarial_review.md`. critical 0(2nd cycle 필요=DoD#5). 엔진/SSOT/render 무수정(report-only).)
