...
|---|---|---|
| 현재(slice 7a 배선) | — | **173** |
| + 상류 column-path 27c | L-1→L-2 4 + L-2→L-3 12 + L-3→L-4 11 | **467** |
...
|---|---|---|---|---|---|
| **A1** | c0250 c0252 (ROUTE, L-3→L-4) | 2 | **312** | +139 | 단일 최대 unlocker(c0250 74·c0252 65 sole-blocker). axis req_det 기배선. |
| **A2** | c0254 c0255 c0256 c0257 (ROUTE, L-3→L-4) | 4 | **353** | +41 | 同 VERB(ROUTE), axis req_det 전부 기배선 → 신규 detection 불요. |
...
|---|---|---|---|---|
| c0250 | ROUTE COLUMN_SCHEMA | route | c0200 | ✅ |
| c0252 | ROUTE AMT | route | c0204 | ✅ |
| c0254 | ROUTE COVARIATE_LAYOUT | route | c0207 | ✅ |
| c0255 | ROUTE ANALYTE_COLUMN | route | c0208 | ✅ |
| c0256 | ROUTE CROSS_COLUMN_INVARIANT | route | c0209 | ✅ |
| c0257 | ROUTE ROW_ORDERING | route | c0206 | ✅ |
